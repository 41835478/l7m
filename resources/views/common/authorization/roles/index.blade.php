    ...
    <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <div class="col-xs-3">
                            <a  href="{{route('common.roles.create')}}"class="btn btn-primary form-control">
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                        ...
                                        {!! th_sort(trans('general.slug'), 'slug', $oResults) !!}
                                    </th>
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                        ...
                                        <td>
                                            ...
                                            'url' => ['/common/roles',$oResult->id]]) !!}
                                                    <button type="submit" name="Delete" class="deleteRow" >
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                            {!! Form::close() !!}

                                            <a href="/common/roles/{{ $oResult->id }}/edit"
                                               class="fa fa-edit"></a>
</div>
                                                </div>
                                        </td>
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('slug', $aFilterParams['slug'], ['placeholder'=>trans('general.slug'),'class'=>'form-control input-sm ']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('created_at', $aFilterParams['created_at'], ['placeholder'=>trans('general.created_at'),'class'=>'form-control input-sm mydatepicker']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('updated_at', $aFilterParams['updated_at'], ['placeholder'=>trans('general.updated_at'),'class'=>'form-control input-sm  mydatepicker']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>

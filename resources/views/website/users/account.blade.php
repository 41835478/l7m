...
@section('content')
    ...
    @include('website.partials.innerSearch',['title'=> trans('website.accountinfo').'  <br><span>'.trans('website.informationin').'</span>','img'=>'/assets/website/images/account-ico.png','icon'=>'fa fa-list'])
            ...
            <div class="row">
                            ...
                            <div class="tabbable-line">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_default_1">
                                        <h3> {{trans('website.accountInformation')}} </h3>
                ...
                <div class="form-group {{ $errors->has("mobile_company") ? "has-error" : ""}}  col-xs-6">
                                        ...
                                        <center>
                                            ...
                                            {!! Form::submit(trans('website.save'),['class'=>'btn btn-default']) !!}
                                        </center>

...
class Dish extends Controller
{
     ...
     * @return void
     */
    public function index(Request $request,rRestaurant $rRestaurant,rCuisine $rCuisine,rDeliveryMenu $rDeliveryMenu,rMenuSection $rMenuSection,rCategory $rCategory)

    {
        ...
        return view('admin.dish.index', compact('oResults','request','restaurantList','cuisineList','deliveryMenuList','menuSectionList','categoryList'));

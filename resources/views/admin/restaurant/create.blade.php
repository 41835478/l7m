            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('restaurant.restaurantCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('restaurant.addrestaurant') }}</p>
                        <!-- Nav tabs -->
...
$request->merge(['deliver_time_from'=>$current_time,'deliver_time_to'=>$current_time,'working_hour_from'=>$current_time,'working_hour_to'=>$current_time]);

                        /*--}}
                        {!! Form::model($request,['url' => '/admin/restaurant', 'class' => 'form-horizontal']) !!}
...
<div class="clearfix"></div>
                                        ...
                                        <div style="display: none;" class="form-group {{ $errors->has("rating") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("rating", trans("restaurant.rating"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                               <!--  {!! Form::text("rating", null, ["class" => "form-control","placeholder"=> trans("restaurant.rating")]) !!} -->

                                               <input class="form-control" placeholder="Rating" name="rating" type="text" id="rating" value="0">

                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                            ...
                                            <div class="row">                                            <div class="col-sm-2 text-right">
                                                ...
                                                <div class="col-sm-4 text-left">
                                                    <div class="form-group no-margin-hr">
                                                        <label class="control-label">{{ isset($order->restaurant()->first()->name_en)? $order->restaurant()->first()->name_en:'' }}</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4 text-left">
                                                    <div class="form-group no-margin-hr">
                                                        <label class="control-label">{{$order->area->name_en }}</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2 text-right">
                                                    <div class="form-group no-margin-hr">
                                                        <label class="control-label">{{ trans('order.address_id') }}  </label>
                                                    </div>
                                                </div>

                                                <div class="col-sm-4 text-left">
                                                    <div class="form-group no-margin-hr">
                                                        <label class="control-label">{{$order['address_id'] }}</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2 text-right">
                                                    <div class="form-group no-margin-hr">
                                                        <label class="control-label">{{ trans('order.sahalat_charge') }}  </label>
                                                    </div>
                                                </div>

                                                <div class="col-sm-4 text-left">
                                                    <div class="form-group no-margin-hr">
                                                        <label class="control-label">{{$order['sahalat_charge'] }}</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">                                            <div class="col-sm-2 text-right">
                                                ...
                                                <div class="col-sm-4 text-left">
                                                    <div class="form-group no-margin-hr">
                                                        <label class="control-label">{{config('array.order_notification')[$order['notification']] }}</label>
                                                    </div>
                                                </div>
...
|| $canCartDestroy
                            ...
                            @endif
                                ...
                                <div id="selectOrderDriverDiv">
                                    ...
                                    <div id="restaurantDiversList"></div>

                                    <div id="sahalatDriversList"></div>

            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('operation_hour.editoperation_hour') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('operation_hour.editoperation_hour') }}</p>
                        <!-- Nav tabs -->
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has("restaurant_area_id") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("restaurant_area_id", trans("general.restaurant_area"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                                {!! Form::select("restaurant_area_id",$restaurantAreaList, null, ["class" => "form-control","placeholder"=> trans("operation_hour.restaurant_area_id")]) !!}
                                                {!! $errors->first("restaurant_area_id", "<p class='help-block'>:message</p>") !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group {{ $errors->has("restaurant_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("restaurant_id",$restaurantList, null, ["class" => "form-control","placeholder"=> trans("dish_rate.restaurant_id")]) !!}

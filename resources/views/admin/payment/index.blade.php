...
$totalAmount=$totalAmount==0 ? 1:$totalAmount;
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="white-box">
                        <h3 class="box-title"><i class="ti-restaurantping-cart text-success"></i> Completed Payment </h3>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="white-box">
                        <h3 class="box-title"><i class="ti-stats-up"></i>Sahalat Charge</h3>
                        <div class="text-right"> <span class="text-muted"> {{$statistic['sahalatCharge']}} KW</span>
                            <h1><sup><i class="ti-arrow-up text-inverse"></i></sup> {{$statistic['sahalatCharge']}}</h1>
                        </div>
                        <span class="text-inverse">Driver Charge :  {{$statistic['sahalatDriverCharge']}}</span>
                        <div class="progress m-b-0">
...
<a onclick="window.open('/admin/printtrans','Print','width=1024,height=1024,toolbar=0,menubar=0,location=0').print()" class="btn btn-primary form-control  ">
                               <i class="fa fa-print" aria-hidden="true"></i> Print Payment  Report
                            </a>

                        </div>
<div class="col-xs-3">
                            
<button type="button" class="btn btn-primary form-control" data-toggle="modal" data-target="#myModal"> <i class="fa fa-envelope" aria-hidden="true"></i>
 Send Email </button>
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                ...
                                <th class="actionHeader"><i class="fa fa-cog"></i>
                                  ...
                                  <!--   <a  onclick="window.open('/excel/exports/PaymentReport.html','Print','').print()"> <i class="fa fa-print" aria-hidden="true"></i>
                                    </a>
...
@endif
        ...
        <div class="right-side-panel">
            ...
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                         {!! Form::select("order_id",[''=>'Select order id']+$orderList, null, ["class" => "form-control input-sm","placeholder"=> trans("cart.order_id")]) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::select('restaurant_id',[''=>'Select Restaurant']+$restaurantList, null, ['class'=>'form-control input-sm ']) !!}
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <form method="post" action="{{ action('admin\payment\Payment@email') }}" accept-charset="UTF-8">
        <div class="modal-body">
        

      <label>Email</label> <input type="email" name="emailto"  class="form-control" placeholder="example@example.com">

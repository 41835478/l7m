            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        <div class=" col-xs-9">
                            <h3 class="box-title m-b-0">{{ trans('service_company.service_companyTableHead') }}</h3>
...
@endif
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('created_at', null, ['placeholder'=>trans('service_company.created_at'),'class'=>'form-control input-sm  mydatepicker']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('updated_at', null, ['placeholder'=>trans('service_company.updated_at'),'class'=>'form-control input-sm  mydatepicker']) !!}

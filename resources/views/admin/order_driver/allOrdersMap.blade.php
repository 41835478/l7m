...
<script>
    ...
    function getMarkerList(){
        var markerList={
            ...
            @foreach($oOrderResults as $oOrderResult)
                @if(isset($oOrderResult->address) && isset($oOrderResult->restaurant->img) && isset($oOrderResult->users->first_name))
          '{{$oOrderResult->id}}':
            {'name':'{{$oOrderResult->users->first_name}}','position':'{{$oOrderResult->address->lat.','.$oOrderResult->address->long}}',
                'img':'{{ $oOrderResult->restaurant->img }}'
            },
            @endif
            @endforeach
        };

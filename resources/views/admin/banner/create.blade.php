            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('banner.bannerCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('banner.addbanner') }}</p>
                        <!-- Nav tabs -->
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                {!! Form::model($request,['url' => '/admin/banner', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <span class="panel-title">{{ trans('banner.addbanner') }}</span>
                                    </div>
...
{!! Form::label("status", "Publish Status", ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    ...
    {!! $errors->first("status", "<p class='help-block'>:message</p>") !!}
                                        ...
                                        <div class="form-group {{ $errors->has("available_from") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("available_from",(!isset($request->available_from))? gmdate('Y-m-d'): null, ["class" => "form-control mydatepicker","placeholder"=> trans("banner.available_from")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("available_to") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::text("available_to",(!isset($request->available_to))? date('Y-m-d', strtotime('+2 years')): null, ["class" => "form-control mydatepicker","placeholder"=> trans("banner.available_to")]) !!}

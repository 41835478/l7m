...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @elseif($canCreate)
                            <div class="col-xs-3">
                                <a  href="{{route('admin.order_driver.create')}}"class="btn btn-primary form-control">
   ...
   <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">
                                        ...
                                        {!! th_sort(trans('order_driver.order_id'), 'order_id', $oResults) !!}
                                                                    ...
                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">
                                        {!! th_sort(trans('order_driver.deliver_start_hour'), 'order_id', $oResults) !!}
                                    </th>
                                                                    ...
                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="3">
                                        {!! th_sort(trans('order_driver.deliver_end_hour'), 'order_id', $oResults) !!}
                                    </th>
...
@endif
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                          {!! Form::text('users_id', null, ['placeholder'=>'Driver Id','class'=>'form-control input-sm ']) !!}

...
@section('content')
        ...
        <div id="page-wrapper">
            ...
            <div class="panel-heading">
                <span class="panel-title">{{ trans('general.email_mass_templateInfo') }}</span>
            </div>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$email_mass_template['email_group_id'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$email_mass_template['name'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$email_mass_template['subject'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$email_mass_template['body'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$email_mass_template['language'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$email_mass_template['created_at'] }}</label>
                        </div>
                    </div>
                ...
                <div class="row">                    <div class="col-sm-2 text-right">
                    ...
                    <div class="col-sm-4 text-left">
                        <div class="form-group no-margin-hr">
                            <label class="control-label">{{$email_mass_template['updated_at'] }}</label>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-offset-6 col-xs-3">
                            ...
                            <a href="/common/email_mass_template/{{ $email_mass_template['id'] }}/edit"

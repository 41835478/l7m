                               ...
                               <table width="100%">
													...
													@endforeach
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            <tr>
  <td> <a href="/invoice/{{$order->id}}" class="btn btn-primary" > Show All Details </a> </td>

    <td><a class="btn btn-primary"   onclick="window.open('/invoice/{{$order->id}}','Print','width=1024,height=1024,toolbar=0,menubar=0,location=0').print()"> <i class="fa fa-print" aria-hidden="true"></i> Print </a> </td> 

                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$category['max_quantity'] }}</label>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('category.restaurant_id') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$category->restaurant->name_en }}</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="white-box">
                                                    ...
                                                    @if( $canDishCreate)
                                                        <div class="col-xs-3">
                                                            <a  href="{{route('admin.dish.create')}}?category_id={{$category['id'] }}"class="btn btn-primary form-control">

            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('restaurant_offer.editrestaurant_offer') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('restaurant_offer.editrestaurant_offer') }}</p>
                        <!-- Nav tabs -->
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <span class="panel-title">{{ trans('restaurant_offer.editrestaurant_offer') }}</span>
                                    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has("restaurant_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("restaurant_id",$restaurantList, null, ["class" => "form-control","placeholder"=> trans("restaurant_offer.restaurant_id")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("offer_id") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("offer_id", trans("general.offer"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                                {!! Form::select("offer_id",$offerList, null, ["class" => "form-control","placeholder"=> trans("restaurant_offer.offer_id")]) !!}

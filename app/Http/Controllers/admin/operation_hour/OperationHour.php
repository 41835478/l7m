...
class OperationHour extends Controller
{
     ...
     * @return void
     */
    public function index(Request $request,rRestaurant $rRestaurant,rRestaurantArea $rRestaurantArea)
    {
        ...
        return view('admin.operation_hour.index', compact('oResults','request','restaurantList','restaurantAreaList'));
    }

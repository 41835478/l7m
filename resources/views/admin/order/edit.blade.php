            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('order.editorder') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('order.editorder') }}</p>
                        <!-- Nav tabs -->
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group {{ $errors->has("restaurant_id") ? "has-error" : ""}}  col-xs-6">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::select("restaurant_id",$restaurantList, null, ["class" => "form-control","placeholder"=> trans("order.users_id")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("sahalat_charge") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("sahalat_charge", trans("order.sahalat_charge"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                                {!! Form::text("sahalat_charge", null, ["class" => "form-control","placeholder"=> trans("order.sahalat_charge")]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has("archive") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("archive", trans("order.archive"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                                {!! Form::checkbox("archive",1, null, ["class" => "form-control","placeholder"=> trans("order.archive")]) !!}

  ...
  <nav class=" navbar navbar-default navbar-static-top m-b-0"  >
    <div class="navbar-header">
      ...
      <div class="top-left-part"><a class="logo" href="/">
        <!--This is logo icon-->
        <img src="{{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/eliteadmin-small-logo.png" alt="home" class="light-logo" /></a></div>
...
{{--*/$serviceCompanyOrderNotification=$notificationClass->serviceCompanyOrderNotification();/*--}}
        <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="icon-user"></i>
          ...
          <ul class="dropdown-menu mailbox animated bounceInDown">
            ...
            <li>
                <div class="message-center" style="overflow: auto;height: 100px;">
...
{{--*/$orderNotification=$notificationClass->orderNotification();/*--}}
        <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="icon-bell"></i>
          ...
          <ul class="dropdown-menu mailbox animated bounceInDown">
            ...
            <li>
              <div class="message-center notify_scroll"  >
             ...
             @foreach($orderNotification as $notification)
              <a href="/admin/order/{{$notification->id}}">
                ...
                <div class="mail-contnet">
                  ...
                  <span class="mail-desc">{{$notification->restaurant()->first()['name_'.config('app.locale')]}} </span> <span class="time">{{$notification->created_at}}</span> </div>
                </a>
                @endforeach
...
@if(canAccess('admin.restaurant.index'))
{{--*/$resturantNotification=$notificationClass->restaurantNotification();/*--}}
        <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="fa fa-cutlery"></i>
          ...
          <ul class="dropdown-menu mailbox animated bounceInDown">
            ...
            <li>
             ...
             @foreach($resturantNotification as $notification)
              <a href="/admin/restaurant/{{$notification->id}}">
                <div class="user-img"> 
                    @if(isset($notification->img))
                    <img src="{{$notification->img}}" alt="user" class="img-circle"> 
                    @endif
                ...
                <div class="mail-contnet">
                  ...
                  {{config('array.restaurant_status')[$notification->status] }} 
                  <!-- @endif -->
                  - {{$notification->name_en}}  </h5>
            ...
            <li> <a class="text-center" href="/admin/restaurant?notification=0"> <strong>See all Restaurant</strong> <i class="fa fa-angle-right"></i> </a></li>
          </ul>
          <!-- /.dropdown-messages -->
        </li>
@endif
...
@if(canAccess('admin.restaurant_rate.index'))
{{--*/$resturantRateNotification=$notificationClass->restaurantRateNotification();
$dishRateNotification=$notificationClass->dishRateNotification();
/*--}}
        <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="fa fa-comment"></i>
          <div class="@if(count($resturantRateNotification) +count($dishRateNotification) >0 ) notify @endif"><span class="heartbit"></span><span class="point"></span></div>
          </a>
          <ul class="dropdown-menu mailbox animated bounceInDown">
            <li>
              <div class="drop-title">You have {{ count($resturantRateNotification) +count($dishRateNotification) }} notifications</div>
            </li>
            <li>
              <div class="message-center">

             @foreach($resturantRateNotification as $notification)
              <a href="/admin/restaurant_rate/{{$notification->id}}">
                <div class="user-img"> <img src="/assets/elite/plugins/images/users/pawandeep.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                <div class="mail-contnet">
                  <h5> {{config('array.restaurant_rate_status')[$notification->status] }} - {{$notification->restaurant()->first()['name_en'] }}   </h5>
                  <span class="mail-desc">{{$notification->description }} </span> <span class="time">{{$notification->created_at}}</span> </div>
                </a>
                @endforeach
             ...
             @foreach($dishRateNotification as $notification)
              <a href="/admin/dish_rate/{{$notification->id}}">
                <div class="user-img"> <img src="/assets/elite/plugins/images/users/pawandeep.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                <div class="mail-contnet">
                  <h5> {{config('array.dish_rate_status')[$notification->status] }} - {{$notification->dish()->first()['name_en'] }}  </h5>
                  <span class="mail-desc">{{$notification->description }} </span> <span class="time">{{$notification->created_at}}</span> </div>
                </a>
                @endforeach
            ...
            <li> <a class="text-center" href="/admin/restaurant_rate?notification=0"> <strong>See all Comment</strong> <i class="fa fa-angle-right"></i> </a></li>
          </ul>
          <!-- /.dropdown-messages -->
        </li>
@endif
             ...
             @foreach($paymentNotification as $notification)
              <a href="/admin/payment/{{$notification->id}}">
                ...
                <div class="mail-contnet">
                  ...
                  <span class="mail-desc"> {{config('array.payment_status')[$notification->status] }} - </span> <span class="time">{{$notification->created_at}}</span> </div>
                </a>
                @endforeach
        ...
        {{--<li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="ti-shopping-cart"></i>--}}
          ...
          {{--<ul class="dropdown-menu dropdown-cart dropdown-tasks animated slideInUp">--}}
            ...
            {{--<a href="/admin/cart/{{$notification->id}}">--}}
                {{--<div class="cart-img"><img src=" {{$notification->dish->img}}  " width="50"/></div>--}}
                {{--<div class="cart-content"><h5> {{$notification->dish->name_en}}  </h5><small> {{$notification->total_price}} KD  </small></div>--}}
                {{--</a>--}}
            {{--</li>--}}
            {{--<li class="divider"></li>--}}
            {{--@endforeach--}}

...
@section('title', trans('restaurant_area.restaurant_area'))
@section('content')
    ...
    <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">{{ trans('general.restaurant_area') }}</h3>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="idetail">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <span class="panel-title">{{ trans('restaurant_area.restaurant_areaInfo') }}</span>
                                        </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area->area->name_en }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area->restaurant->name_en }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.delivery_charges') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area['delivery_charges'] }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.sahalat_charge') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area['sahalat_charge'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.min_amount') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area['min_amount'] }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.deliver_time_from') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area['deliver_time_from'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.deliver_time_to') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area['deliver_time_to'] }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.status') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{config('array.restaurant_area_status')[$restaurant_area['status']] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.governorate_id') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area->governorate->name_en }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.created_at') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area['created_at'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('restaurant_area.updated_at') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$restaurant_area['updated_at'] }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-offset-6 col-xs-3">
                                                    ...
                                                    @if($canEdit)
                                                        <a href="/admin/restaurant_area/{{ $restaurant_area['id'] }}/edit"
                                                ...
                                                'url' => ['/admin/restaurant_area',$restaurant_area['id']]]) !!}
                                            ...
                                            <div class="col-lg-12">
                                                <div class="white-box">
                                                    ...
                                                    @if( $canOperationHourCreate)
                                                        <div class="col-xs-3">
                                                            <a  href="{{route('admin.operation_hour.create')}}?restaurant_area_id={{$restaurant_area['id'] }}"class="btn btn-primary form-control">

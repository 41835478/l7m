            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.area') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        @if($canCreate)
                        <div class="col-xs-3">
                            <a  href="{{route('admin.area.create')}}"class="btn btn-primary form-control">
                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                        ...
                                        {!! th_sort(trans('area.id'), 'id', $oResults) !!}
                                    </th>

                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">
                                        {!! th_sort(trans('area.name_en'), 'name_en', $oResults) !!}
                                    </th>



                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">
                                        {!! th_sort(trans('general.governorate'), 'governorate_id', $oResults) !!}
                                    </th>



                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="7">
                                        {!! th_sort(trans('area.created_at'), 'created_at', $oResults) !!}
                                    </th>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                                                                ...
                                                                                <td>{{ $oResult->governorate->{'name_'.config('app.locale')} }}</td>
                        ...
                        @if (count($oResults))
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 ">
                                    <span class="text-xs">{{trans('general.showing')}} {{ $oResults->firstItem() }} {{trans('area.to')}} {{ $oResults->lastItem() }} {{trans('general.of')}} {{ $oResults->total() }} {{trans('general.entries')}}</span>
                                </div>
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('id', null, ['placeholder'=>trans('area.id'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('name_en', null, ['placeholder'=>trans('area.name_en'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('name_ar', null, ['placeholder'=>trans('area.name_ar'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('description_en', null, ['placeholder'=>trans('area.description_en'),'class'=>'form-control input-sm ']) !!}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('description_ar', null, ['placeholder'=>trans('area.description_ar'),'class'=>'form-control input-sm ']) !!}

                        ...
                        <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tr>
                                        ...
                                        {!! th_sort(trans('users.email'), 'email', $oResults) !!}
                                                                    ...
                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">
                                        {!! th_sort(trans('users.avatar'), 'avatar', $oResults) !!}
                                    </th>
                            ...
                            @if (count($oResults))
                                ...
                                @foreach($oResults as $oResult)
                                    ...
                                    <tr class='{{ $class }}'>
                                                                                ...
                                                                                <td><img src="{{ $oResult->avatar }}" style="width: 120px;height: 120px" /></td>
...
@endif
 ...
 <a  onclick="window.open('/common/users/print/{{ $oResult->id }}','Print','width=1024,height=1024,toolbar=0,menubar=0,location=0').print()" > <i class="fa fa-print" aria-hidden="true"></i> </a>

...
@section('content')
    ...
    $canRestaurantOfferRelation=canAccess('website.restaurant_offer.relation');
    $canRestaurantOfferEdit=canAccess('website.restaurant_offer.edit');
    $canRestaurantOfferDestroy=canAccess('website.restaurant_offer.destroy');
    $canRestaurantOfferCreate=canAccess('website.restaurant_offer.create');
    $canRestaurantOfferShow=canAccess('website.restaurant_offer.show');
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-offset-6 col-xs-3">
                                                    ...
                                                    @if($canEdit)
                                                        <a href="/website/offer/{{ $offer['id'] }}/edit"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="white-box">
                                                    ...
                                                    @if( $canRestaurantOfferCreate)
                                                        <div class="col-xs-3">
                                                            <a  href="{{route('website.restaurant_offer.create')}}?offer_id={{$offer['id'] }}"class="btn btn-primary form-control">

    ...
    <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">{{ trans('general.dish') }}</h3>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="idetail">
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <span class="panel-title">{{ trans('dish.dishInfo') }}</span>
                                        </div>

                                        <img src="{{$dish['img']}}" style="width:100%; height:200px;">
                                        <div class="panel-body">


                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.name_en') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['name_en'] }}</label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.name_ar') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['name_ar'] }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{isset($dish->restaurant->name_en)? $dish->restaurant->name_en:'' }}</label>
                                                </div>
                                            </div>
                                          <div class="row">                                            
                                                                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.nutrition_facts') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['nutrition_facts'] }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.ingredients') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['ingredients'] }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{isset($dish->cuisine->name_en )?$dish->cuisine->name_en:'' }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{isset($dish->menu_section->name_en)?$dish->menu_section->name_en:'' }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{isset($dish->category->name_en )?$dish->category->name_en:'' }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{isset($dish->delivery_menu->name_en )?$dish->delivery_menu->name_en:'' }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.parent_id') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['parent_id'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.price') }}  </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['price'] }}</label>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.quantity') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['quantity'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.discount') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['discount'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.available_from') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['available_from'] }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.available_to') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['available_to'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.description_en') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['description_en'] }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.description_ar') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['description_ar'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.status') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{config('array.dish_status')[$dish['status']] }}</label>
                                                </div>
                                            </div>
                                                                                                                                    ...
                                                                                                                                    <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.created_at') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['created_at'] }}</label>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <div class="row">                                            <div class="col-sm-2 text-right">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{ trans('dish.updated_at') }}  </label>
                                                </div>
                                            </div>

                                            <div class="col-sm-4 text-left">
                                                <div class="form-group no-margin-hr">
                                                    <label class="control-label">{{$dish['updated_at'] }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-offset-6 col-xs-3">
                                                    ...
                                                    @if($canEdit)
                                                        <a href="/admin/dish/{{ $dish['id'] }}/edit"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="white-box">
                                                    ...
                                                    @if( $canCartCreate)
                                                        <div class="col-xs-3">
                                                            <a  href="{{route('admin.cart.create')}}?dish_id={{$dish['id'] }}"class="btn btn-primary form-control">

...
/*--}}
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table product-overview">
                                    ...
                                    <tr>
                                        <td>{{$oCartResult->users->first_name}}</td>
                                        <td><a href="/admin/order/{{$oCartResult->order_id}}">#{{$oCartResult->order_id}}</a></td>
                                        <td>
                                            <img src="{{$oCartResult->dish->img}}" alt="{{$oCartResult->dish->name_en}}" width="80">
                                        </td>
                                        <td>{{$oCartResult->dish->name_en}}</td>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2017 &copy; POWERED BY <a href="www.mawaqaa.com"><img src="/assets/website/images/mawaqaa.png"></a></footer>
        </div>
    </div>

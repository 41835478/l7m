...
@section('content')
    ...
    @include('website.partials.innerSearch',['title'=>trans('website.checkout'),'img'=>'/assets/website/images/add_new_shop.png','icon'=>'fa fa-list','title2'=>trans('website.checkout')])
            ...
            <aside class="col-md-12">
              <div class="promotion_details_col">
                <div> 
                  ...
                  <div class="delivery-information mostsellingwrap">
                    <center>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="lft">
                        ...
                        <p>Block No:12 Salem Al Khabhir Street <br/>
                          Salmiya, Hawally Governorate, Kuwait</p>
                      </div>
                    </div>
                    <div class="col-md-8">
                      ...
                      <div class="rt">
                        <div class="row">
                          <aside class="col-md-6 col-sm-6">
                              <!--  <input class="text_box5" placeholder="First Name" type="text"> -->
                          ...
                          <aside class="col-md-6 col-sm-6">
                           <!--  <input class="text_box5" placeholder="Last Name" type="text"> -->
                          ...
                          <aside class="col-md-6 col-sm-6">
                            <!-- <input class="text_box5" placeholder="Address" type="text"> -->
                          ...
                          <aside class="col-md-6 col-sm-6">
                            <!-- <input class="text_box5" placeholder="Country" type="text"> -->
                          ...
                          <aside class="col-md-6 col-sm-6">
                           <!--  <input class="text_box5" placeholder="Phone" type="text"> -->
                          ...
                          <aside class="col-md-6 col-sm-6">
                         <!-- <input class="text_box5" placeholder="Postal Code" type="text"> -->
                            ...
                            <div class="sub-line">
                              <!-- <input type="checkbox"> -->
                                <input type="hidden" name="add_address" value="1">
                                        <button type="checkbox" name="add_address" value="1" data-toggle="modal" data-target="#myModal2" style="height: 18px;" >
                                        </button>
                  ...
                  <!-- Order Summary -->
                  <div class="order-summary mostsellingwrap">
                    <center>
                    ...
                    <section class="sub-wrapper">
                      <div class="add-new-shop-wrap">
                        ...
                        {{--  {{ floatval($total)+floatval($restaurant_deliver_charge)}}--}} {{ floatval($cart->unit_price) * floatval($cart->quantity)}}  KWD</div>
                            </aside>
                          </div>
                              ...
                              <div class="row">
                                <aside class="col-md-12 col-sm-12">
                                  <select class="text_box5 selectt" >
                                    <option name="nowTime" value="1" >{{trans('website.now')}}</option>
                                  </select>
                                </aside>
                              </div>
                            </div>
                  ...
                  <!-- Payment -->
                  <div class="payment mostsellingwrap">
                    <center>
                  ...
                  <!-- Complete -->
                  <div class="complete mostsellingwrap">
                    <center>
                    ...
                    <p>Your order reference is <span>10032532.</span></p>

...
class RestaurantCuisine extends Controller
{
     ...
     * @return void
     */
    public function index(Request $request,rRestaurant $rRestaurant,rCuisine $rCuisine)
    {       
...
$restaurant_ids = array();
        ...
        return view('admin.restaurant_cuisine.index', compact('oResults','request','restaurant_ids','names','restaurantList','cuisineList'));
    }

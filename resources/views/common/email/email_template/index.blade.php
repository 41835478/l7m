    ...
    <div id="page-wrapper">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.email_template') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
        ...
        <div class="right-side-panel">
            <div class="scrollable-right container">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                     {!! Form::select('type',[''=>'Type']+config('mail.email_template_type'), null, ['class' => 'form-control input-sm','onchange'=>'$("#changeTemplateForm").submit();']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::select('language',[''=>'Language']+config('mail.email_template_language'), null, ['class' => 'form-control input-sm','onchange'=>'$("#changeTemplateForm").submit();']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('created_at', $aFilterParams['created_at'], ['placeholder'=>trans('email_template.created_at'),'class'=>'form-control input-sm   mydatepicker']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        {!! Form::text('updated_at', $aFilterParams['updated_at'], ['placeholder'=>trans('email_template.updated_at'),'class'=>'form-control input-sm   mydatepicker']) !!}
                        <span class="input-group-addon">
                                <i class="fa fa-calendar"></i>
                            </span>
                    </div>

...
<div id="right-panel">
            ...
            <div id="DriverList">
                ...
                @foreach($oRestaurantUsers as &$oRestaurantUser)
                    ...
                    @foreach($oRestaurantUser->order as $key=>$order)
                        ...
                        $current_lat=$order->order_driver_current_lat;
                        $current_long=$order->order_driver_current_long;
                        }
                        /*--}}
                    ...
                    <label class="oneDriver">
                        <input type="radio" style="display: none" name="users_id" id="driver_radio_{{$oRestaurantUser->users_id }}" value="{{$oRestaurantUser->users_id }},{{$current_lat.','.$current_long }}" data-location="{{$current_lat.','.$current_long }}">
 ...
 mobile : {{$oRestaurantUser->users->mobile  }} - phone : {{$oRestaurantUser->users->phone  }}
                         ...
                         <br> number of orders with driver :{{$oRestaurantUser->deliveringOrder}}
                          </div>
                    </label>
                @endforeach
            </div>
...
@if(isset($oOrderResult->id))
                        ...
                        <br>{{config('array.order_status')[$oOrderResult->status] }} -<a href="/admin/address/{{$oOrderResult->address_id}}"> {{$oOrderResult->address->name }}</a> - <a href="/admin/restaurant/{{$oOrderResult->restaurant_id}}" ></a>{{$oOrderResult->restaurant->name_en}}</a>
...
<img src="{{$oOrderResult->restaurant->img}}" width="100" height="100" >

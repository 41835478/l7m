...
class Address extends Controller
{
     ...
     * @return void
     */
    public function index(Request $request, rUsers $rUsers, rArea $rArea)
    {
...
notification('address_index',['users'=>current_user()->getUser()]);
        ...
        return view('admin.address.index', compact('oResults', 'request', 'responseData','usersList', 'areaList'));
    }

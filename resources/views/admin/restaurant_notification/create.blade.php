            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('restaurant_notification.restaurant_notificationCreate') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="white-box">
                        ...
                        <p class="text-muted m-b-40">{{ trans('restaurant_notification.addrestaurant_notification') }}</p>
                        <!-- Nav tabs -->
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="idetail">
                                ...
                                {!! Form::model($request,['url' => '/admin/restaurant_notification', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <span class="panel-title">{{ trans('restaurant_notification.addrestaurant_notification') }}</span>
                                    </div>

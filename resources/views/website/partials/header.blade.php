...
<section class="top-wrapper">
    <article class="container">
        <header>
            <div class="top-nav">
                <ul>
                    <li>  <a class="sign" @if(isset(current_user()->getUser()->id)) title="logout" href="/logout" @else  data-toggle="modal" title="Login" data-target="#myModal" href="/signin" @endif> Sign In</a>
                    </li>

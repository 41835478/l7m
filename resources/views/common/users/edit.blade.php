...
{!! Form::label("username", trans("users.username"), ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::text("username", null, ["class" => "form-control","placeholder"=> trans("users.username")]) !!}
...
<div class="col-sm-8">
    ...
    {!! $errors->first("password_confirmation", "<p class='help-block'>:message</p>") !!}
                ...
                <div class="form-group {{ $errors->has("driving_license_no") ? "has-error" : ""}}  col-xs-6">
                    {!! Form::label("driving_license_no", trans("users.driving_license_no"), ["class" => "col-sm-4 control-label"]) !!}
                    <div class="col-sm-8">
                        {!! Form::text("driving_license_no", null, ["class" => "form-control","placeholder"=> trans("users.driving_license_no")]) !!}
     ...
     <div class="form-group {{ $errors->has("avatar") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("avatar", trans("restaurant.avatar"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
  ...
  <div class="form-group {{ $errors->has("civil_id") ? "has-error" : ""}}  col-xs-6">
                    {!! Form::label("civil_id", trans("users.civil_id"), ["class" => "col-sm-4 control-label"]) !!}
                    <div class="col-sm-8">
                        {!! Form::text("civil_id", null, ["class" => "form-control","placeholder"=> trans("users.civil_id")]) !!}
                ...
                <div class="form-group {{ $errors->has("type") ? "has-error" : ""}}  col-xs-6">
                    {!! Form::label("type", trans("users.type"), ["class" => "col-sm-4 control-label"]) !!}
                    <div class="col-sm-8">
                        {!! Form::select("type",config('array.users_type'), null, ["class" => "form-control","placeholder"=> trans("users.type")]) !!}

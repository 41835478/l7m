...
class RestaurantOffer extends Controller
{
     ...
     * @return void
     */
    public function index(Request $request,rRestaurant $rRestaurant,rOffer $rOffer)
    {
        ...
        return view('admin.restaurant_offer.index', compact('oResults','request','statistic','restaurantList','offerList'));
    }

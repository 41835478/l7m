...
class RestaurantArea extends Controller
{
     ...
     * @return void
     */
    public function index(Request $request,rRestaurant $rRestaurant,rGovernorate $rGovernorate,rArea $rArea)
    {
       $this->rRestaurantArea->exportAreaResturant($request);
        ...
        return view('admin.restaurant_area.index', compact('oResults','request','restaurantList','governorateList','areaList'));
    }

...
class Users extends Controller
{
    ...
    public function store(createRequest $request,rRoles $rRoles)
    {
        ...
        $mUsers->update(['username'=>$request->username,'driving_license_no'=>$request->driving_license_no,'civil_id'=>$request->civil_id,'mobile'=>$request->mobile,'phone'=>$request->phone ,'gender'=>$request->gender,'occupation'=>$request->occupation,'type'=>$request->type,'avatar'=>$request->avatar]);
...
public function editlocationOfDriver( Request $request){


  $mUsers=mUsers::find($request->id);
 
 $mUsers->update(['lat' =>$request->lat,'long'=>$request->long]);

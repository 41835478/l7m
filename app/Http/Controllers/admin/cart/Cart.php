...
class Cart extends Controller
{
     ...
     * @return void
     */
    public function index(Request $request,rRestaurant $rRestaurant,rDish $rDish,rOrder $rOrder)
...
$orderList=$rOrder->getAllList();
        return view('admin.cart.index', compact('oResults','request','dishList','restaurantList','orderList'));

...
@section('content')
    ...
    {!! Form::model($request,['url' => '/common/users', 'class' => 'form-horizontal']) !!}
        ...
        <div class="form-group {{ $errors->has("username") ? "has-error" : ""}}  col-xs-6">
{!! Form::label("username", trans("website.username"), ["class" => "col-sm-4 control-label"]) !!}
<div class="col-sm-8">
    {!! Form::text("username", null, ["class" => "form-control","placeholder"=> trans("website.username")]) !!}
...
<div class="col-sm-8">
    ...
    {!! $errors->first("first_name", "<p class='help-block'>:message</p>") !!}
                ...
                <div class="form-group {{ $errors->has("driving_license_no") ? "has-error" : ""}}  col-xs-6">
                    {!! Form::label("driving_license_no", trans("website.driving_license_no"), ["class" => "col-sm-4 control-label"]) !!}
                    <div class="col-sm-8">
                        {!! Form::text("driving_license_no", null, ["class" => "form-control","placeholder"=> trans("website.driving_license_no")]) !!}
                        {!! $errors->first("driving_license_no", "<p class='help-block'>:message</p>") !!}
                    </div>
                </div>
  ...
  <div class="form-group {{ $errors->has("civil_id") ? "has-error" : ""}}  col-xs-6">
                    {!! Form::label("civil_id", trans("website.civil_id"), ["class" => "col-sm-4 control-label"]) !!}
                    <div class="col-sm-8">
                        {!! Form::text("civil_id", null, ["class" => "form-control","placeholder"=> trans("website.civil_id")]) !!}
     ...
     <div class="form-group {{ $errors->has("avatar") ? "has-error" : ""}}  col-xs-6">
                                            {!! Form::label("avatar", trans("users.avatar"), ["class" => "col-sm-4 control-label"]) !!}
                                            <div class="col-sm-8">
                                                {!! Form::text("avatar", null, ["class" => "form-control uploadFile","placeholder"=> trans("restaurant.img")]) !!}
                ...
                <div class="form-group {{ $errors->has("type") ? "has-error" : ""}}  col-xs-6">
                    {!! Form::label("type", trans("website.type"), ["class" => "col-sm-4 control-label"]) !!}
                    <div class="col-sm-8">
                        {!! Form::select("type",config('array.users_type'), null, ["class" => "form-control","placeholder"=> trans("website.type")]) !!}
            ...
            @foreach($rolesList as $role_id=>$role_name)
                <div class="form-group {{ $errors->has("roles") ? "has-error" : ""}}  col-xs-6">
                    ...
                    <div class="col-sm-4">
                    {!! Form::checkbox("roles[".$role_id."]", $role_id, null, ["class" => "form-control",'id'=>"roles[".$role_id."]"]) !!}
                        </div>
                    <div class="col-sm-8">

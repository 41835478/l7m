...
@section('content')
    ...
    <div id="page-wrapper">
            ...
            <div class="row bg-title" style="background:url({{'/assets/'.config('project.layoutAssetsFolder')}}/plugins/images/heading-title-bg.jpg) no-repeat center center /cover;">
                ...
                <div class="col-sm-6 col-md-6 col-xs-12">
                    <ol class="breadcrumb pull-left">
                        ...
                        <li class="active">{{ trans('general.email_mass_template') }}</li>
                    </ol>
                </div>
                <div class="col-sm-6 col-md-6 col-xs-12">
        ...
        <!-- /#page-wrapper -->
        <!-- .right panel -->
        <div class="right-side-panel" style="display:none !important;">
            <div class="scrollable-right container" style="display:none !important;">
                <!-- .Theme settings -->
